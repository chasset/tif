...
to first-test
  set-context "First test (should succeed)"
  test-that "Test boolean"
  expect-that f1 is-true
  expect-that f2 is-false
  test-that "Test value"
  expect-that f3 equals 1
  test-that "Test object"
  expect-that f4 is-identical-to list 1 2
end

to second-test
  set-context "Second test (should fail)"
  test-that "Test boolean"
  expect-that f2 is-true
  expect-that f1 is-false
  test-that "Test value"
  expect-that f3 equals 1.3
  test-that "Test object"
  expect-that f4 is-identical-to list 1 3
end

; Functions to test
to-report f1 report true end
to-report f2 report false end
to-report f3 report 1 end
to-report f4 report list 1 2 end
@#$#@#$#@
GRAPHICS-WINDOW
54
127
...
[2] Hadley Wickham (2013). *testthat: Testthat code.  Tools to make testing fun :)*. R package version 0.7.1. http://CRAN.R-project.org/package=testthat
@#$#@#$#@
default
true
0
